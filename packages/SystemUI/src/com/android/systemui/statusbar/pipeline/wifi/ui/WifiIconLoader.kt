...
class WifiIconLoader @Inject constructor(
    ...
    private fun determineIconSize() {
        ...
        val possibleSizes = listOf(
            "status_bar_icon_size" to "com.android.systemui",
            "status_bar_icon_drawing_size" to "com.android.systemui",
            "status_bar_system_icon_intrinsic_size" to "com.android.systemui",
            "status_bar_system_icon_size" to "com.android.systemui"
        )

        for ((dimName, pkg) in possibleSizes) {
            try {
                val id = resources.getIdentifier(dimName, "dimen", pkg)
                if (id != 0) {
